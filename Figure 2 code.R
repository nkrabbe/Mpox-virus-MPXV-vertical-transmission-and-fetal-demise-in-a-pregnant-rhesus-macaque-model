...
fluidVL <- read_excel("C:\\Users\\Nkrab\\Downloads\\Figure 2 Raw Data.xlsx", sheet = 2, col_names = TRUE)
fluidVL$ID <- as.character(fluidVL$ID)
tissueVL <- read_excel("C:\\Users\\Nkrab\\Downloads\\Figure 2 Raw Data.xlsx", sheet = 3, col_names = TRUE)
...
combinedVLgraph<- ggarrange(tissueVLgraph, fluidVLgraph, 
          ...
          align = "hv")
combinedVLgraph
ggsave(filename="combinedVLgraph.tiff", plot=combinedVLgraph, 
